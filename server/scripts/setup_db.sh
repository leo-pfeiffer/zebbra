...
mongoimport --db zebbra --collection models --drop --file $DEMO_DIR/invite_codes.json --jsonArray
...
mongoimport --db zebbra_test --collection workspaces --drop --file $DEMO_DIR/invite_codes.json --jsonArray
