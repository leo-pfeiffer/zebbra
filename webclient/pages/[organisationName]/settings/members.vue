          ...
          <div class="border border-zinc-300 rounded">
            <table class="w-full text-sm text-left">
              <tr class="border-b border-zinc-300">
                <td class="py-3 px-3 text-xs uppercase font-medium text-zinc-500 bg-zinc-100 border-zinc-300 rounded-tl">NAME</td>
              ...
              <tr v-for="member in members" class="border-b border-zinc-300 last:border-0">
                <td class="py-3 px-3 text-zinc-900"><span class="rounded-full bg-green-500 text-neutral-50 shadow-sm text-xs p-1.5 mr-2">{{member.first_name[0]}}{{member.last_name[0]}}</span>{{member.first_name}} {{member.last_name}}</td>
                <td class="py-3 px-3 text-zinc-500">{{member.username}}</td>
                <td class="py-3 px-3 text-zinc-500">{{member.user_role}}</td>
                <td class="py-3 px-3 text-zinc-500"><MemberListDropdown :username="member.username"></MemberListDropdown></td>
              </tr>
            </table>
          </div>
