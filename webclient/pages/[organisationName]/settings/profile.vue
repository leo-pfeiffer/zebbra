      ...
      <div class="mt-8 px-4 sm:px-[20%] lg:px-[25%]">
        ...
        <div class="py-6">
          ...
          <div v-if="otpSetUp">
            ...
            <button v-show="!showOtpUrl" class="bg-red-600  drop-shadow-sm
                      shadow-zinc-50 text-sm font-medium px-2.5 py-1
                      border border-red-500 rounded text-neutral-100" @click="setup2FA">Reset 2FA</button>
          </div>

          <div v-if="!otpSetUp">
            <p class="text-sm text-zinc-500 my-3">
              Add an extra security layer to your account by setting up 2-factor authentication here.
            </p>
            <button v-show="!showOtpUrl" class="bg-sky-600  drop-shadow-sm
                      shadow-zinc-50 text-sm font-medium px-2.5 py-1
                      border border-sky-500 rounded text-neutral-100" @click="setup2FA">Set up 2FA</button>
          </div>

          <div v-if="showOtpUrl">
            <ol class="text-xs text-zinc-500 my-3 mx-6 list-decimal">
              <li>Download and install any authenticator app on your phone.</li>
              <li>Use the app to scan the QR code below.</li>
              <li>Enter the code generated by the app.</li>
              <li>Validate!</li>
            </ol>
            <img class="my-3" :src="`https://api.qrserver.com/v1/create-qr-code/?data=${otpUrl}&amp;size=100x100`"
              alt="" title="" />
