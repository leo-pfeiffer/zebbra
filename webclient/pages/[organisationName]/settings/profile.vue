        ...
        <div class="py-6">
          ...
          <div v-if="!otpSetUp">
            <p class="text-sm text-zinc-500 my-3">
              Connect an authenticator app, such as Google Authenticator to generate verification codes.
              You can use the codes whenever Zebbra tries to verify your identity, for example when signing in
            </p>
            <button
                v-show="!showOtpUrl"
                class="bg-sky-600  drop-shadow-sm
          ...
          <div v-if="showOtpUrl">
            <ol class="text-sm text-zinc-500 my-3 mx-6 list-decimal">
              <li>Download and install an authenticator app on your phone.</li>
