...
describe('useGetHumanReadableFormula Tests', () => {
    ...
    it.todo('should return the correct human readable format with only internal ref', () => {

    });

    it.todo('should return the correct human readable format with only external ref', () => {
